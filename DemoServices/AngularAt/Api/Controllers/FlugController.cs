...
{   
    ...
    public class FlugController : ApiController
    {
        ...
        public FlugController()
        {
            if (fluege.Count == 0)
            {
                fluege.Add(new Flug { Id = 1, Abflugort = "Graz", Zielort ="Hamburg", Datum = DateTime.Now, FreiePlaetze = 190, Plaetze = 200 });
                fluege.Add(new Flug { Id = 2, Abflugort = "Graz", Zielort = "Hamburg", Datum = DateTime.Now.AddHours(2), FreiePlaetze = 68, Plaetze = 200  });
                fluege.Add(new Flug { Id = 3, Abflugort = "Graz", Zielort = "Hamburg", Datum = DateTime.Now.AddHours(4), FreiePlaetze = 77, Plaetze = 200 });
                fluege.Add(new Flug { Id = 4, Abflugort = "Graz", Zielort = "Mallorca", Datum = DateTime.Now, FreiePlaetze = 88, Plaetze = 200 }); 
            }
        }
        ...
        [Route("odata")]
        [CustomEnableQuery]
        public IQueryable<Flug> GetOData()
        {
            return fluege.AsQueryable();
        }
